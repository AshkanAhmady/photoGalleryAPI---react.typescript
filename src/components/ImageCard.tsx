...
import { ImageCardComponentProps } from "../Interfaces";

const ImageCard: React.FC<ImageCardComponentProps> = (props) => {
  ...
  return (
    ...
    <div style={{ gridRowEnd: `span ${spans}` }}>
      <img alt="searched_img" ref={imageRef} src={props!.image.urls.small} />
    </div>
  );
};
